...
/**
* This Thread, when started, consumes the specified input stream.
* This can be useful to prevent a thread that is filling a buffered
* stream from blocking when the buffer fills.
...
public class StreamGobbler extends Thread {
	...
	/**
	 *  Close the input stream (and output stream if it exists) passed into this
