...
public class ExtFilenameFilter implements FilenameFilter, FileFilter {
	...
	private  HashMap<String,ExtFilenameFilter> filters = null;
	...
	**/
	...
	public ExtFilenameFilter( String[] filters, String description ) {
		this.filters = new HashMap<String,ExtFilenameFilter>( filters.length );
	...
	**/
	...
	public final void addExtension( String extension ) {
		if ( filters == null )
			filters = new HashMap<String,ExtFilenameFilter>( 5 );

		if ( extension != null && ! extension.equals( "" ) ) {
			//  Trim any leading "." characters from the supplied extension.
			int i = extension.lastIndexOf( '.' );
			if (i >= 0 && i < extension.length())
