...
if(main1_frame.mapper.containsKey(no)){
	mcqq testa=(mcqq)main1_frame.mapper.get(no);
	main1_frame.mapper.remove(no);
	testa.title="\\question {"+title.getText()+".\r\n";
	testa.utitle=title.getText();
	testa.mcq+=MCQ;
	//System.out.println(testa.mcq);
	main1_frame.mapper.put(no,testa);
