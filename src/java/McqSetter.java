 ...
 * @author User
 */
public class McqSetter extends javax.swing.JFrame {
    ...
    private void TableActionPerformed(java.awt.event.ActionEvent evt){
       ...
       McqTableAdder a=new McqTableAdder(this);
       a.setVisible(true);
    ...
    private void initComponents(){
        	...
        	public void actionPerformed(ActionEvent arg0){
        	 ...
        	 int no= (int) qno.getValue();
       		...
       		if(g.mapper.containsKey(no)){
       			...
       			//MainFrame.mapper.put(no,testa);
       			McqObject r=(McqObject)testa.mcqlist.get(sqn);
  		        ...
  		        abimgpath="";
              		...
              		McqObject r=new McqObject(sqn,MCQ);
       				r.subquestion=Question.getText();
           			r.ans1=Op1.getText();
           			r.ans2=Op1.getText();
           			r.ans3=Op1.getText();
        ...
        qno.addChangeListener(new ChangeListener() {
        	public void stateChanged(ChangeEvent arg0) {
        		...
        		if(g.mapper.containsKey(r)){
        	    	...
        	    	String tit=o.utitle;
        	    	McqObject mc=(McqObject)o.mcqlist.get(1);
        	    	Title.setText(tit);
        ...
        sqno.addChangeListener(new ChangeListener() {
        	public void stateChanged(ChangeEvent arg0) {
        		...
        		McqObject o=(McqObject)mcb.mcqlist.get(no);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(McqSetter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
